...
class ITMPluginWorks {
    ...
    public static function html(){
        ?>
            ...
            ?>
            <nav><h3>How it works</h3><a href="?page=<?php echo ITM_PLUGIN; ?>&view=plugin-settings">Plugin Settings</a><a href="?page=<?php echo ITM_PLUGIN; ?>&view=how-it-works" class="active">How it works</a><a href="?page=<?php echo ITM_PLUGIN; ?>&view=support">Support</a></nav>
            ...
            <div id="how-it-works" class="itm-wrap">
                ...
                <!--Start Name/Title Settings-->
                    ...
                    <small class="guide">Clean All will removed any non-word characters, and make stripping numbers optional: ex. strip_numbers true [Dalina, Bradley B. 09264482952]</small>
                    <div class="demo"><b>Dalina Bradley B</b></div>
                    <br/>
                    <small class="guide">Preserved All will preserved the entire characters, and make stripping numbers disabled: [Dalina, Bradley B. 09264482952]</small>
                    <div class="demo"><b>Dalina, Bradley B. 09264482952</b></div>
                    <br/>
                    <small class="guide">Preserved Special works the same with preserved all but allow to stripping numbers optional ex. strip_numbers true: [Dalina, Bradley B. 09264482952]</small>
                    <div class="demo"><b>Dalina, Bradley B. </b></div>
                    <br/>
                    ...
                    <br/><br/>
                    <span class="status">If "Add Post/Page title to alt or title attibute" is checked, this will append the attachment page title at the end of the image alt or title attribute. There is two available separator the hypen ( - ) and bar ( | ).<br/><br/>
                    ...
                    <br/>
                    <small class="guide">Unchanged, Lowercase, Uppercase, Capitalized, Sentence:</small>
                    <div class="demo"><b>Bradley daLina, bradley dalina, BRADLEY DALINA, Bradley Dalina, Bradley dalina</b></div>
                <br/><br/>
                ...
                NOTE: Please read carefully and apply the settings if you clearly understand, if you don't trust this plugin's ability and don't want this to modify the post. Just ignore this option.</span><br/><br/>
                <span class="status">The plugin makes allows the user to enable or disable js_filter as this could affect the site speed. It has also a js_log option that allows the user to seen what images has been filtered by the js.</span>
