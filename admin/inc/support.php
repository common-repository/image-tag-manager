...
class ITMPluginSupport {
    ...
    public static function html(){
        ?>
        <nav><h3>Support</h3><a href="?page=<?php echo ITM_PLUGIN; ?>&view=plugin-settings">Plugin Settings</a><a href="?page=<?php echo ITM_PLUGIN; ?>&view=how-it-works">How it works</a><a href="?page=<?php echo ITM_PLUGIN; ?>&view=support" class="active">Support</a></nav>
